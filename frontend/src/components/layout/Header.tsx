          ...
          <DropdownMenuTrigger asChild>
            <Button variant="outline" className="flex items-center gap-2 max-w-[280px]">
              <span className="truncate text-sm">
                {activeProject ? activeProject.name : 'Simulation auswählen'}
              </span>
              <ChevronDown className="h-3 w-3 shrink-0 text-slate-400" />
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent align="start" className="w-72">
            <DropdownMenuLabel>Simulationen</DropdownMenuLabel>
            ...
            <DropdownMenuItem onClick={() => navigate('/projekte/neu')}>
              ...
              <span className="text-[#0079C0] font-medium">Neue Simulation erstellen</span>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
